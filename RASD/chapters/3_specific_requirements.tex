...
In this section, it is given a complete description of the functional requirements of the system.
    ...
    \begin{enumerate}[label=\textbf{UC.\arabic*}]
    	    ...
    	    \centering
                ...
                \begin{tabular}{|m{3.2cm}|m{9.8cm}|}
                    ...
                    \begin{itemize}
                        ...
                        \item  If an information is incorrect the system will throw an error message and the educator will be requested to modify it. An incorrect information can be a deadline that is before the current date.
                    \end{itemize}\\
                    \hline 
                \end{tabular}
        \end{table}
        ...
        \item \lbl{uc: rankB} \textbf{See battle ranking}
