...
\subsection{Scenario 2: Tournament and battle creation}
...
\subsubsection{A team does not reach the minimum number of participants}
...
\subsection{Scenario 6: Gamification badges management}
